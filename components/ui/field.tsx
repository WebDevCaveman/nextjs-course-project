...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-fg-subtle text-left text-xs leading-normal font-normal group-has-data-[orientation=horizontal]/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
...
function FieldSeparator({
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className="bg-background text-fg-subtle relative mx-auto block w-fit px-2 text-[13px]"
...
function FieldError({
  ...
  return (
    <div role="alert" data-slot="field-error" className={cn("text-danger text-xs font-normal", className)} {...props}>
      {content}
    </div>
  );
}
