...
| --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Page wrapper**<br>`main`                                      | `flex-1 min-w-0 flex flex-col gap-10 px-[30px] py-10`                                                                                                                                                                                                                                                                             | Left nav and right panel are siblings of `main`, not children. **No max-width** — the two rails already bound the content, so a cap on top of them only parks dead gutters on either side once the shell grows wider than it.                                                                                                                                                                                                                                        |
