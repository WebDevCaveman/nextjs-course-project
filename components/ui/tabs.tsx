  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        // Profile "Top Posts / Answers" — see STYLING.md "Segmented tab strip".
        segmented: "bg-muted rounded-2xl p-1.5 group-data-[orientation=horizontal]/tabs:h-[52px]",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=segmented]/tabs-list:rounded-xl group-data-[variant=segmented]/tabs-list:px-6 group-data-[variant=segmented]/tabs-list:text-base group-data-[variant=segmented]/tabs-list:font-semibold group-data-[variant=segmented]/tabs-list:text-fg-muted group-data-[variant=segmented]/tabs-list:data-[state=active]:text-accent-solid dark:group-data-[variant=segmented]/tabs-list:data-[state=active]:border-transparent dark:group-data-[variant=segmented]/tabs-list:data-[state=active]:bg-background dark:group-data-[variant=segmented]/tabs-list:data-[state=active]:text-accent-solid",
